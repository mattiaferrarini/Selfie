  ...
  setup() {
    ...
    const login = async () => {
      if (username.value.trim() == "" || password.value.trim() == "") {
        errorMessage.value = "I valori dei campi non possono essere vuoti!";
        return;
      }
      try {
